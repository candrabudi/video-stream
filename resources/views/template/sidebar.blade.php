<aside id="sidebar"
    class="sidebar sidebar-mini fixed left-0 top-14 bottom-0 bg-black border-r border-gray-800 overflow-y-auto z-40">
    <nav class="p-2" style="margin-top: 25px;">
        <a href="#" class="nav-item active">
            <svg class="nav-icon w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
