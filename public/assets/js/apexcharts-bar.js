(function () {
    ...
    var options = {
        ...
        colors: ["var(--primary-color)", "#f46ef4"],
        dataLabels: {
            enabled: true,
            offsetX: -10,
            style: {
    ...
    var options = {
        ...
        colors: ["var(--primary-color)", "#f46ef4", "#9e5cf7", "#fa4b42", "#28c8eb"],
        grid: {
            borderColor: '#f2f5f7',
        },
        title: {
    ...
    var options = {
        ...
        colors: ["var(--primary-color)", "#f46ef4", "#9e5cf7", "#fa4b42", "#28c8eb", "#ff8100", "#be2aed"],
        grid: {
            borderColor: '#f2f5f7',
        },
        dataLabels: {
    ...
    var options = {
        ...
        colors: ["var(--primary-color)", "#f46ef4", "#9e5cf7", "#28c8eb"],
        title: {
